/*
 * Attribute should be given to the project FluentFlyouts3
...
namespace BatteryTracker.Models
{
    ...
    {
        public static readonly PowerPlan PowerSaver = new(PowerPlanEnum.PowerSaver, new Guid(PowerPlanIds.PowerSaver));

        public static readonly PowerPlan Recommended = new(PowerPlanEnum.Recommended, new Guid(PowerPlanIds.Recommended));

        public static readonly PowerPlan BetterPerformance = new(PowerPlanEnum.BetterPerformance, new Guid(PowerPlanIds.BetterPerformance));

        public static readonly PowerPlan BestPerformance = new(PowerPlanEnum.BestPerformance, new Guid(PowerPlanIds.BestPerformance));
    }
}
